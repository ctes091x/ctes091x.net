...
![Ubuntuのインストール時に出てくる「どうやってUbuntuをインストールしますか？」の画面](./how_do_you_install.png)
...
![コンリテで使用するウィンドウをいくつか開いた様子](./complite_window.png)
